...
class PipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        secret = secretsmanager.Secret(
            self,
            f"iac_{APP_NAME}_docker_secret",
        ...
        secret = secretsmanager.Secret(
            self,
            f"iac_{APP_NAME}_codecommit_secret",
        ...
        secret = secretsmanager.Secret(
            self,
            f"iac_{APP_NAME}_argocd_secret",
            ...
            environment=codebuild.BuildEnvironment(
                environment_variables={
                    "APP_ENDPOINT": codebuild.BuildEnvironmentVariable(
                        value="https://uat-skillsets-api.lmasu.co.za/get_all_engineers"
                    ),
                    "ENV": codebuild.BuildEnvironmentVariable(value="uat"),
                    "APP_NAME": codebuild.BuildEnvironmentVariable(value=APP_NAME),
        ...
        self.slack = chatbot.SlackChannelConfiguration(
            self,
            "MySlackChannel",
            slack_channel_configuration_name="test-pipeline-notifications",
            slack_workspace_id="T05M84V305Q",
            slack_channel_id="C05NZUNL5LJ",
        )
        ...
        cdk.CfnOutput(
            self,
            f"iac-{APP_NAME}-slack-channel",
            value=self.slack.slack_channel_configuration_arn,
            export_name="iac-slack",
        )
